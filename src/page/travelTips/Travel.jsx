...
function Travel() {
  return (
    <div>
      ...
      <AnimatedBackground />
      <div>
        <h1 className="text-[black] text-[3rem] text-center font-bold mt-[20px] font-serif sm:text-[4rem]">
          Our Blog
        </h1>
        <div className="grid grid-cols justify-center pl-[14%] gap-10 xl:flex col xl:pl-[0]  md:grid grid-cols lg:grid cols lg:pl-[0] ">
          <div className="w-[74vw]mb-10 h-[30] mt-[20px] sm:w-[67vw] lg:w-[50vw] xl:w-[42vw]">
            <Zoom
              src={FirstZoom}
            ...
            <h2 className="text-[2rem] text-[#5A5A5A] hover:text-[#B19885] transition duration-1000">
              Instant Booking
            </h2>
            <p className="text-[#50524F] mt-[17px]">
              ...
              secure their stay effortlessly. Our secure payment gateway ensures
              peace of mind during the booking process
            </p>
          </div>

          <div className="w-[74vw] mb-10 h-[30] mt-[20px] sm:w-[67vw] lg:w-[50vw]">
            <Zoom2 src={secondZoom} altText="Description for image 1" />
            <p className="text-[#AAAAAA] mt-[20px] hover:text-[#BAA380] transition duration-1000 font-medium ">
              RAYAPARTMENT'S EXPLORER'S HUB
            </p>
            <h2 className="text-[2rem] text-[#5A5A5A] hover:text-[#6E6F6E]">
              Suggestions
            </h2>
            <p className="text-[#50524F] mt-[17px]">
              {" "}
              With advanced algorithms and user preferences, Ray Apartment
              offers personalized accommodation recommendations tailored to
              individual needs and preferences.
            </p>
          </div>

          <div className="w-[74vw] mb-10 h-[30] mt-[20px] sm:w-[67vw] lg:w-[50vw] xl:w-[42vw]">
            <Zoom src={thirdZoom} altText="Description for image 1" />
            <p className="text-[#AAAAAA] mt-[20px] hover:text-[#BAA380] transition duration-1000 font-medium ">
              RAYAPARTMENT'S EXPLORER'S HUB
            </p>
            <h2 className="text-[2rem] text-[#5A5A5A] hover:text-[#6E6F6E]">
            ...
            <p className="text-[#50524F] mt-[17px]">
              Ray Apartment specializes in meeting the unique needs of business
              travelers. From seamless corporate bookings to cutting-edge
              meeting facilities, we ensure a productive and comfortable stay.
              Enjoy executive amenities and personalized service tailored to
        ...
        <div className="grid grid-cols justify-center gap-10 pl-[14%] xl:flex col xl:pl-[0]  md:grid-cols lg:grid-cols lg:pl-[0]">
          <div className="w-[74vw] mb-10 h-[30] mt-[20px] sm:w-[67vw] lg:mt-[-5rem] lg:w-[50vw] xl:w-[42vw]">
            <Zoom
              src={fifthZoom}
              altText="Description for image 1"
              class="firstZoom"
            ...
            <p className="text-[#50524F] mt-[17px]">
              Ray Apartment prioritizes sustainability, providing eco-friendly
              accommodation options for conscientious travelers. Our commitment
              to the environment ensures guests can enjoy a greener stay while
              reducing their carbon footprint. Experience responsible
              hospitality with our eco-conscious initiatives at Ray Apartment.
            </p>
          </div>

          <div className="w-[74vw] mb-10 h-[30] mt-[20px] sm:w-[67vw] lg:w-[50vw]">
            <Zoom2 src={sixthZoom} altText="Description for image 1" />
            <p className="text-[#AAAAAA] mt-[20px] hover:text-[#BAA380] transition duration-1000 font-medium ">
              RAYAPARTMENT'S EXPLORER'S HUB
            </p>
            <h2 className="text-[2rem] text-[#5A5A5A] hover:text-[#6E6F6E]">
          ...
          <div className="w-[74vw] h-[30] mb-10 mt-[20px] sm:w-[67vw] lg:mt-[-5rem] lg:w-[50vw] xl:w-[42vw]">
            <Zoom src={seventhZoom} altText="Description for image 1" />
            <p className="text-[#AAAAAA] mt-[20px] hover:text-[#BAA380] transition duration-1000 font-medium ">
              RAYAPARTMENT'S EXPLORER'S HUB
            </p>
            <h2 className="text-[2rem] text-[#5A5A5A] hover:text-[#6E6F6E]">
            ...
            <p className="text-[#50524F] mt-[17px]">
              ...
              is here to help with bookings, inquiries, and any support services
              you may require. Enjoy peace of mind knowing that help is just a
              phone call or message away at Ray Apartment.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-[40px] font-serif">
        ...
        <div className="bg-[#151719] grid justify-center gap-[5rem]  py-[6rem] sm:grid xl:flex col">
          <div
            className="text-center border-2 border-[#B99D75] mx-[40px]  px-[40px] py-[5rem] 
          ...
          >
            ...
            <h1 className="text-[white] text-[1.7rem] mt-[20px] font-normal sm:text-[2rem] xl:text-[2rem]">
              Let's start a conversation
            </h1>
            <p className="text-[#AAABAB] mt-[30px]">
              {" "}
              Affirmative! Let's kick off a dialogue{" "}
            </p>
            <div class="myInput">
          ...
          <div
            className="relative w-[90vw] h-[82vh] ml-[6%] flex items-center justify-center bg-cover bg-
